...
typedef struct{
	...
	lv_font_t*font_bold;
	lv_font_t*font_ital;
	lv_font_t*font_bold_ital;
	termview_osc_cb osc_cb;
	termview_write_cb write_cb;
	termview_resize_cb resize_cb;
}lv_termview_ext_t;

enum{LV_TERMVIEW_PART_BG=LV_CANVAS_PART_MAIN};
typedef uint8_t lv_termview_style_t;
...
extern void lv_termview_set_font(lv_obj_t*tv,lv_font_t*font);
...
extern lv_obj_t*lv_termview_create(lv_obj_t*par,const lv_obj_t*copy);
#ifdef __cplusplus
}
#endif
#endif
