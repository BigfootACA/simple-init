if("${SYSTEM_FREETYPE2}" STREQUAL "OFF")
	...
	include_directories(
		...
		"${PROJECT_BINARY_DIR}/libs/freetype/include/freetype/config"
	)
	...
	if(HAVE_UNISTD_H)
		...
		set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -DHAVE_UNISTD_H=1")
	endif()
	if(HAVE_FCNTL_H)
		string(REGEX REPLACE "#undef +(HAVE_FCNTL_H)" "#define \\1 1" FTCONFIG_H "${FTCONFIG_H}")
		set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -DHAVE_FCNTL_H=1")
	endif()
	set(FTCONFIG_H_NAME "${PROJECT_BINARY_DIR}/libs/freetype/include/freetype/config/ftconfig.h")
	...
	set(FTOPTION_H_NAME "${PROJECT_BINARY_DIR}/libs/freetype/include/freetype/config/ftoption.h")
	...
	set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -DFT2_BUILD_LIBRARY=1 '-DFT_CONFIG_OPTIONS_H=<ftoption.h>'")
	set(FT2_SRCS
