...
static struct topology_val {
	...
	{ BLKIOMIN, blkid_topology_set_minimum_io_size, .set_int = 0 },
	{ BLKIOOPT, blkid_topology_set_optimal_io_size, .set_int = 0 },
	{ BLKPBSZGET, blkid_topology_set_physical_sector_size, .set_int = 0 }
