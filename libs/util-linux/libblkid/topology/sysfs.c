...
static struct topology_val {
	...
	{ "queue/minimum_io_size", blkid_topology_set_minimum_io_size, .set_int = 0 },
	{ "queue/optimal_io_size", blkid_topology_set_optimal_io_size, .set_int = 0 },
	{ "queue/physical_block_size", blkid_topology_set_physical_sector_size, .set_int = 0 },
	{ "queue/dax", blkid_topology_set_dax, .set_int = 0 },
};
		...
		const struct blkid_idmag *mag __attribute__((__unused__)))
{
	...
	for (i = 0; i < ARRLEN(topology_vals); i++) {
