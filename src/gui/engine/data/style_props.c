...
xml_style_prop xml_style_props[]={
	...
	DECL_STYLE(LV_STYLE_BG_COLOR_FILTERED,       bg-color-filtered,       STYLE_COLOR,        0)
	DECL_STYLE(LV_STYLE_BG_OPA,                  bg-opa,                  STYLE_OPA,          LV_OPA_COVER)
	DECL_STYLE(LV_STYLE_BG_GRAD_COLOR,           bg-grad-color,           STYLE_COLOR,        0)
	DECL_STYLE(LV_STYLE_BG_GRAD_COLOR_FILTERED,  bg-grad-color-filtered,  STYLE_COLOR,        0)
	...
	DECL_STYLE(LV_STYLE_BG_IMG_RECOLOR_FILTERED, bg-img-recolor-filtered, STYLE_COLOR,        0)
	...
	DECL_STYLE(LV_STYLE_BORDER_COLOR_FILTERED,   border-color-filtered,   STYLE_COLOR,        0)
	...
	DECL_STYLE(LV_STYLE_OUTLINE_COLOR_FILTERED,  outline-color-filtered,  STYLE_COLOR,        0)
	...
	DECL_STYLE(LV_STYLE_SHADOW_COLOR_FILTERED,   shadow-color-filtered,   STYLE_COLOR,        0)
	...
	DECL_STYLE(LV_STYLE_IMG_RECOLOR_FILTERED,    img-recolor-filtered,    STYLE_COLOR,        0)
	...
	DECL_STYLE(LV_STYLE_LINE_COLOR_FILTERED,     line-color-filtered,     STYLE_COLOR,        0)
	...
	DECL_STYLE(LV_STYLE_ARC_COLOR_FILTERED,      arc-color-filtered,      STYLE_COLOR,        0)
	DECL_STYLE(LV_STYLE_ARC_OPA,                 arc-opa,                 STYLE_OPA,          LV_OPA_COVER)
	DECL_STYLE(LV_STYLE_TEXT_COLOR,              text-color,              STYLE_COLOR,        0)
	DECL_STYLE(LV_STYLE_TEXT_COLOR_FILTERED,     text-color-filtered,     STYLE_COLOR,        0)
